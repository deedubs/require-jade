define('jade!views/welcome', ['jade'], function(jade){ return function anonymous(locals, attrs, escape, rethrow, merge) {
jade = jade.get().runtime;attrs = attrs || jade.attrs; escape = escape || jade.escape; rethrow = rethrow || jade.rethrow; merge = merge || jade.merge;
var buf = [];
with (locals || {}) {
var interp;
buf.push('<h1>Jade Templates for RequireJS</h1><Below>should be other templates included</Below><h2>' + escape((interp = otherTitle) == null ? '' : interp) + '</h2><b>' + escape((interp = otherOtherTitle) == null ? '' : interp) + '</b>');
}
return buf.join("");
}});
